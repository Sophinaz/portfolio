    ...
    <div name="aboutme" className=' text-center flex flex-col md:flex-row space-y-10 md:space-y-0 justify-between align-middle'>
        <div className='cursor-pointer mx-8 hover:bg-gray-800   bg-gray-900 border-2 rounded-xl md:w-1/2'>
            ...
            <ul className=' flex justify-between w-1/2 mx-auto my-7'>
              <li><a href="https://github.com/Sophinaz?tab=repositories"><img className=' w-11 rounded-full' src={github} alt="" /></a></li>
              <li><a href="https://www.instagram.com/sophinaz_/?hl=en"><img className=' w-11 rounded-full' src={insta} alt="" /></a></li>
              <li><a href="https://www.linkedin.com/in/sophonias-demiss-3020b62ab/"><img className=' w-11 rounded-full' src={linkedin} alt="" /></a></li>
              <li><a href="sophidemiss@gmail.com"><img className=' w-11 rounded-full' src={mail} alt="" /></a></li>
