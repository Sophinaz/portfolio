...
const Experience = () => {
  return (
    <div className=' space-y-6'>
        ...
        <div className=' space-y-6'>
            <h1 className=' font-bold text-3xl'>This portfolio and other small time projects</h1>
            <p className=' text-lg font-light'>This portfolio is buils by using the react frame work and tailwind css and hosted in the hosting service provider vercel.</p>
        </div>
    </div>
  )
}
